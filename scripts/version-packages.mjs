...
// The known workspace is: @websegment/sigma
// All the workspaces in `sigma/crates/node/npm/*` should always be in sync with
// `@websegment/sigma`. You can think of them as one big package, but they are
// split into multiple packages because they are OS specific.
const syncedWorkspaces = new Map([
  [
    '@websegment/sigma',
    [
      'sigma/crates/node/npm/android-arm-eabi',
      'sigma/crates/node/npm/android-arm64',
      'sigma/crates/node/npm/darwin-arm64',
      'sigma/crates/node/npm/darwin-x64',
      'sigma/crates/node/npm/freebsd-x64',
      'sigma/crates/node/npm/linux-arm-gnueabihf',
      'sigma/crates/node/npm/linux-arm64-gnu',
      'sigma/crates/node/npm/linux-arm64-musl',
      'sigma/crates/node/npm/linux-x64-gnu',
      'sigma/crates/node/npm/linux-x64-musl',
      'sigma/crates/node/npm/win32-x64-msvc',
    ],
  ],
])
