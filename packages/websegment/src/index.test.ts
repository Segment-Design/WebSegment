...
describe('compiling CSS', () => {
  test('`@websegment utilities` is replaced with the generated utility classes', () => {
    expect(
      compileCss(
        css`
          @theme {
  ...
  test('`@websegment utilities` is only processed once', () => {
    expect(
      compileCss(
        css`
          @websegment utilities;
  ...
  test('`@websegment utilities` is replaced by utilities using the default theme', () => {
