...
export function help({
  ...
  if (usage && usage.length > 0) {
    ...
    for (let [idx, example] of usage.entries()) {
      ...
      // ```
      //   Usage:
      //     websegment build [--input input.css] [--output output.css] [--watch] [options...]
      //     websegment other [--watch] [options...]
      // ```
      //
      ...
      // ```
      //   Usage:
      //     websegment build [--input input.css] [--output output.css]
      //                       [--watch] [options...]
      //
      //     websegment other [--watch] [options...]
      // ```
      ...
      // ```
      //   Usage:
      //     websegment [--input input.css] [--output output.css] [--watch] [options...]
      // ```
      //
      // E.g.: when not enough space is available
      //
      // ```
      //   Usage:
      //     websegment [--input input.css] [--output output.css]
      //                 [--watch] [options...]
      // ```
      //
